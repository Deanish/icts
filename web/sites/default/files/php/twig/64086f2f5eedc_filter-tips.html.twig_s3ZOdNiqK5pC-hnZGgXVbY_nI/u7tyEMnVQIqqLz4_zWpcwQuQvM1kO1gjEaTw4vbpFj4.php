...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/content-edit/filter-tips.html.twig", "/var/www/html/icts/web/themes/contrib/bootstrap5/templates/content-edit/filter-tips.html.twig");
    }
